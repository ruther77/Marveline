...
from app.core.deps import get_current_user, VpnReaderV3, VpnWriterV3, VpnAdminV3, UserCompat
...
def _get_wg_client(current_user: UserCompat = Depends(get_current_user)) -> WireGuardClient:
