      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {searchable && (
          <div className="relative flex-1 min-w-[200px] max-w-md">
            ...
            <input
              ...
              className={cn(
                'w-full pl-10 pr-10 py-2.5 min-h-[44px] text-sm rounded-xl',
                'bg-dark-900 border border-dark-600 text-dark-50 placeholder-dark-400',
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                ...
                'border border-dark-600 hover:bg-dark-900 text-dark-300'
              )}
            >
        ...
        {activeCount > 0 && (
          <button
            type="button"
            onClick={onReset}
            className="flex items-center gap-2 px-4 py-2.5 text-sm text-dark-400 hover:text-dark-50 transition-colors"
          >
            ...
            return (
              <span
                ...
                className={cn(
                  ...
                  'bg-dark-900 text-dark-200 animate-in fade-in zoom-in-95 duration-200'
                )}
              >
                ...
                <button
                  ...
                  className="flex items-center justify-center w-5 h-5 hover:bg-dark-600 rounded-full transition-colors"
                >
                  <X className="h-3 w-3" />
                </button>
              </span>
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        onClick={onToggle}
        className={cn(
          'flex items-center gap-2 px-4 py-2.5 text-sm rounded-lg transition-all',
          'border',
          hasValue
            ? 'border-primary-500/50 bg-primary-500/10 text-primary-300'
            : 'border-dark-600 hover:bg-dark-900 text-dark-300'
        )}
      >
      ...
      {expanded && (
        <div
          className={cn(
            'absolute top-full left-0 mt-2 min-w-[200px] bg-dark-900 rounded-xl shadow-xl border border-dark-600 py-2 z-30',
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSelected ? 'bg-primary-500/20 text-primary-300' : 'text-dark-300 hover:bg-dark-600'
            )}
          >
            <div className={cn(
    ...
    <div className="p-2">
      <div className="space-y-1">
        {allPresets.map((preset) => (
          <button
            ...
            className={cn(
              'w-full flex items-center gap-2 px-4 py-2 text-sm rounded-lg transition-colors text-left',
              value === preset.value
      ...
      <div className="mt-2 pt-2 border-t border-dark-600">
        ...
        <input
          ...
          className="w-full px-4 py-2 text-sm card text-dark-50 focus:outline-none focus:ring-2 focus:ring-primary-500/50"
        />
      </div>
    </div>
  )
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center gap-4">
        ...
        <span className="text-dark-500 mt-4">—</span>
        <div className="flex-1">
  ...
  return (
    <div className="p-2">
      <input
        ...
        className="w-full px-4 py-2 text-sm card text-dark-50 placeholder-dark-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50"
        autoFocus
      />
    </div>
  )
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={cn(
            'absolute top-full right-0 mt-2 w-72 bg-dark-900 rounded-xl shadow-xl border border-dark-600 p-4 z-30',
            'animate-in fade-in slide-in-from-top-2 duration-200'
          )}
        >
...
function PresetsDropdown({ presets, onSelect, onClose }: PresetsDropdownProps) {
  ...
  return (
    <div
      ref={dropdownRef}
      className={cn(
        'absolute top-full right-0 mt-2 w-64 bg-dark-900 rounded-xl shadow-xl border border-dark-600 py-2 z-30',
        'animate-in fade-in slide-in-from-top-2 duration-200'
      )}
    >
        ...
        {presets.map((preset, index) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-left text-dark-300 hover:bg-dark-600 transition-colors"
            >
