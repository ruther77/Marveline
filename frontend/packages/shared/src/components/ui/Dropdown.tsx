  ...
  return (
    <div ref={dropdownRef} className={cn('relative inline-block', className)}>
      ...
      {isOpen && (
        <div
          className={cn(
            'absolute z-50 min-w-[180px] bg-dark-900 rounded-lg shadow-xl border border-dark-600',
...
export function DropdownSeparator() {
  return <div className="border-t border-dark-600 my-1" />;
}
    ...
    <div className={className}>
      ...
      <Dropdown
        ...
        trigger={
          <div
            className={cn(
              'flex items-center justify-between w-full px-4 py-2.5 bg-dark-900 border rounded-lg',
          ...
          >
            <span className={selectedOption ? 'text-dark-50' : 'text-dark-400'}>
              {selectedOption ? (
