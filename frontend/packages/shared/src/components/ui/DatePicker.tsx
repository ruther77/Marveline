      ...
      <div className={className}>
        ...
        <Dropdown
          ...
          trigger={
            <div
              className={cn(
                'flex items-center gap-2 w-full px-4 py-2.5 bg-dark-900 border rounded-lg cursor-pointer transition-colors',
            ...
            >
              ...
              <span className={value ? 'text-dark-50 flex-1' : 'text-dark-400 flex-1'}>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : isCurrentMonth
                        ? 'text-dark-50 hover:bg-dark-600'
                        : 'text-dark-500',
