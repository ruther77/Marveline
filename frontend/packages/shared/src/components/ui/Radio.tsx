    ...
    return (
      <div className={cn('flex items-start', className)}>
        <div className="relative flex items-center">
          ...
          <div
            className={cn(
              ...
              checked
                ? 'border-primary-600'
                : 'bg-dark-900 border-dark-600 peer-hover:border-dark-500',
        ...
        {(label || description) && (
          ...
          >
            {label && (
              <span className="text-sm font-medium text-dark-50 block">
                {label}
              </span>
            )}
            {description && (
      ...
      {options.map((option) => {
        ...
        return (
          <label
            key={option.value}
            className={cn(
              'relative flex items-start gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all',
              isSelected
                ? 'border-primary-500 bg-primary-900/20'
                : 'border-dark-600 bg-dark-900 hover:border-dark-600',
          ...
          >
            ...
            {option.icon && (
              <div
                className={cn(
                  'p-2 rounded-lg',
                  isSelected ? 'bg-primary-600 text-white' : 'bg-dark-900 text-dark-400'
                )}
              >
                {option.icon}
              </div>
