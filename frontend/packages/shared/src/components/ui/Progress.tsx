...
export function Progress({
  ...
  return (
    <div className={className}>
      ...
      <div
        className={cn(
          'w-full bg-dark-900 rounded-full overflow-hidden',
          sizes[size]
        )}
        role="progressbar"
        aria-valuenow={value}
    ...
    <div className={cn('relative inline-flex', className)}>
      <svg width={size} height={size} className="-rotate-90">
        ...
        <circle
          ...
          className="stroke-dark-600 fill-none"
        />
        {/* Progress circle */}
        <circle
          cx={size / 2}
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div
                className={cn(
                  orientation === 'horizontal' ? 'ml-4' : 'mt-2 text-center'
                )}
              >
                <p
                  className={cn(
                    'text-sm font-medium',
                    status === 'current' ? 'text-dark-50' : 'text-dark-300'
                  )}
                >
                  {step.label}
                </p>
              ...
              <div
                className={cn(
                  orientation === 'horizontal'
                    ? 'flex-1 h-0.5 mx-4'
                    : 'w-0.5 h-8 ml-4 my-2',
                  index < currentStep ? 'bg-primary-600' : 'bg-dark-900'
                )}
              />
            )}
          </div>
