...
function ToastContainer({
  ...
  return (
    <div className="fixed bottom-4 right-4 flex flex-col gap-2 max-w-sm w-full" style={{ zIndex: Z.TOAST }}>
      {toasts.map((toast) => (
...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  return (
    <div
      className={cn(
        'flex items-start gap-2 p-4 rounded-lg border shadow-lg backdrop-blur-sm',
