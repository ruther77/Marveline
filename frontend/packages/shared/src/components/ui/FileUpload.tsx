        ...
        <div className="mt-4 space-y-2">
          {value.map((file, index) => {
            ...
            return (
              <div
                key={`${file.name}-${index}`}
                className="flex items-center gap-2 p-2 bg-dark-900 rounded-lg border border-dark-600"
              >
                {file.preview ? (
                  <img
                    src={file.preview}
                  ...
                  <div className="w-10 h-10 bg-dark-900 rounded flex items-center justify-center">
