        ...
        <div className="bg-white rounded-t-3xl shadow-2xl max-h-[85vh] overflow-hidden">
          ...
          <div className="overflow-y-auto max-h-[60vh] px-6 py-4 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all"
              />
            </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 rounded-2xl font-medium text-sm transition-all active:scale-98 flex items-center justify-between ${
          ...
          <div className="px-6 py-4 border-t border-gray-100 space-y-2">
            {hasFilters && (
              <button
                onClick={clearAll}
                className="w-full py-3 bg-gray-100 text-gray-700 rounded-2xl font-semibold active:scale-98 transition-transform"
              >
                Réinitialiser
              </button>
            )}
