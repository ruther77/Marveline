...
import { useMfaStatus, useMfaSetup, useMfaEnable, useMfaDisable } from '@/api/queries'
...
import { SettingsSkeleton } from '@shared/components/ui/SkeletonPatterns'
...
export default function MFASetupPage() {
  ...
  if (isLoading) {
    return <SettingsSkeleton groups={1} />
  }
    ...
    return (
      <div className="max-w-md mx-auto space-y-6">
        <div className="text-center">
          ...
          <PageHeader title="2FA activé !" subtitle="Sauvegardez ces codes de récupération en lieu sûr" />
        </div>
    ...
    return (
      <div className="max-w-md mx-auto space-y-6">
        ...
        <form onSubmit={handleVerify} className="card space-y-4">
          <div>
            <label className="block text-sm text-dark-400 mb-1">Code de vérification</label>
            <input
              type="text"
              value={verifyCode}
  ...
  return (
    <div className="max-w-2xl space-y-6">
        ...
        <div className="flex items-start gap-4">
          <div
            className={cn(
              ...
              mfaStatus?.enabled ? 'bg-green-500/10' : 'bg-dark-900'
            )}
          >
            {mfaStatus?.enabled ? (
      ...
      <div className="card bg-dark-900/50">
        <h3 className="font-semibold mb-4">Applications recommandées</h3>
