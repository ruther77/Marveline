...
import { ERROR_TITLES, ERROR_MESSAGES, ERROR_ACTIONS } from '@shared/errors'
...
export default function ErrorFallback({
  ...
  if (variant === 'widget') {
    return (
      <div
        className={cn(
          'flex items-center gap-4 p-4 rounded-xl bg-dark-900/50 border border-dark-600/50',
          className,
        )}
      >
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-medium text-primary-400 hover:text-primary-300 hover:bg-primary-500/10 rounded-lg transition-colors"
          >
      ...
      >
        <div className="max-w-md w-full text-center">
          <div className="mb-6 flex justify-center">
            <div className="w-16 h-16 card border border-dark-600/50 flex items-center justify-center">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            {onNavigateHome && (
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-dark-900 hover:bg-dark-600 text-dark-200 text-sm font-medium rounded-xl transition-colors"
              >
  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center">
        <div className="mb-6 flex justify-center">
          <div className="w-14 h-14 card border border-dark-600/50 flex items-center justify-center">
            <Icon className={cn('w-7 h-7', iconColor)} />
          </div>
        </div>
        <h2 className="text-lg font-bold mb-2">{displayTitle}</h2>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          {onNavigateHome && (
            <button
              onClick={onNavigateHome}
              className="flex items-center gap-2 px-4 py-2 bg-dark-900 hover:bg-dark-600 text-dark-200 text-sm font-medium rounded-xl transition-colors"
            >
              <Home className="w-4 h-4" />
              Accueil
            </button>
